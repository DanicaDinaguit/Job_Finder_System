    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            if ($email === $dbemail &&  $password === $dbpassword){
                ...
                header("Location: loggedadmin.html");
                exit();
            }
        else {
...
<body>
    <nav class="navbar navbar-expand-lg" id="nav_color">
        <div class="container-fluid">
            ...
            <a style="text-decoration: none; color: white; margin-right:50px;" href="admin_login.php">ADMINISTRATOR</a>
        </div>
    </nav>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" action="" method="post" style="width: 80%;">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-check text-center"><input name="remember" id="formCheck-1" class="form-check-input-center" type="checkbox" /><label class="form-check-label" for="formCheck-1">Remember Me</label></div>
                                    </div>
