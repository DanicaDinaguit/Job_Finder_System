...
$sql = "SELECT ta.admin_id, ta.admin_fullname, ta.admin_email, ta.admin_password, tap.adminprofile_contactinfo, tap.adminprofile_bio  
        FROM tbl_admin AS ta
        INNER JOIN tbl_adminprofile AS tap
        ON ta.admin_id =  tap.adminprofile_id
        WHERE ta.admin_id = {$_SESSION['id']};";
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    $number = $row["adminprofile_contactinfo"];
    $bio = $row["adminprofile_bio"];
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_update'])) {
    ...
    $sql = "UPDATE tbl_admin AS ta
            INNER JOIN tbl_adminprofile AS tap ON ta.admin_id = tap.admin_id
            SET ta.admin_fullname='$fullname', ta.admin_email='$email', ta.admin_password='$password', tap.adminprofile_contactinfo='$number', ta.admin_sex='$sex', tap.adminprofile_bio='$bio'
            WHERE ta.admin_id=$userid;";
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item">
                <a id="nav_item" class="nav-link" aria-current="page" href="admin_manage.php">Manage Profiles
                </a>
              </li>
